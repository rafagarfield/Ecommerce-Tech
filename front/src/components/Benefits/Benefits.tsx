...
const Benefits = () => {
  return (
    <div className='flex flex-wrap justify-center items-center text-[#fff] font-semibold'>
      <div className='bg-[#198FFD] w-full sm:w-1/3 p-4 flex justify-center'>ENVÍO GRATIS</div>
      <div className='bg-[#FDC62E] w-full sm:w-1/3 p-4 flex justify-center'>GARANTÍA ASEGURADA</div>
      <div className='bg-[#2CD06F] w-full sm:w-1/3 p-4 flex justify-center'>SOPORTE 24/7</div>
    </div>
  );
};
